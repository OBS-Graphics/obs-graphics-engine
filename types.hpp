...
struct Paint {
    ...
    inline static Paint Solid(double r, double g, double b, double a = 1.0) {
        Paint p;
        p.type = Type::Solid;
        p.params[0] = r; p.params[1] = g; p.params[2] = b; p.params[3] = a;
        return p;
    }
    ...
    inline static Paint Linear(double x0, double y0, double x1, double y1) {
        Paint p;
        p.type = Type::Linear;
        p.params[0] = x0; p.params[1] = y0; p.params[2] = x1; p.params[3] = y1;
        return p;
    }
    ...
    inline static Paint Radial(double cx0, double cy0, double r0,
        ...
        Paint p;
        p.type = Type::Radial;
        p.params[0] = cx0; p.params[1] = cy0; p.params[2] = r0;
        p.params[3] = cx1; p.params[4] = cy1; p.params[5] = r1;
        return p;
    }
    ...
    inline bool Valid() const { return type != Type::None; }
    ...
    inline void Apply(cairo_t* cr, double w, double h) const {
        ...
        if (type == Type::Linear) {
            pat = cairo_pattern_create_linear(
                params[0]*w, params[1]*h, params[2]*w, params[3]*h);
        } else {
            pat = cairo_pattern_create_radial(
                params[0]*w, params[1]*h, params[2]*w,
